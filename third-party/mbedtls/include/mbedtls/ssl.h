...
/*
 * ENHANCEMENT by FotaHub: Implementation-defined maximum fragment length codes indicating that 
 * maximum fragment length limit must be applied after completion of TLS handshake only.
 */
#define MBEDTLS_SSL_MAX_FRAG_LEN_POST_HANDSHAKE_512    0x11  
#define MBEDTLS_SSL_MAX_FRAG_LEN_POST_HANDSHAKE_1024   0x12  
#define MBEDTLS_SSL_MAX_FRAG_LEN_POST_HANDSHAKE_2048   0x13  
#define MBEDTLS_SSL_MAX_FRAG_LEN_POST_HANDSHAKE_4096   0x14   

/*
 * ENHANCEMENT by FotaHub: Add support for maximum data rate negotiation
 * TLS extension.
 */
#define MBEDTLS_SSL_MAX_DATA_RATE_NONE          0   /*!< don't use this extension   */
 ...
 * TLS extension.
 */
#define MBEDTLS_TLS_EXT_MAX_DATA_RATE           0xFF09
 ...
 * TLS extension.
 */
#if defined(MBEDTLS_SSL_MAX_DATA_RATE)
    unsigned char max_data_rate;/*!< MaxDataRate negotiated by peer */
#endif /* MBEDTLS_SSL_MAX_DATA_RATE */
 ...
 */
#if defined(MBEDTLS_SSL_MAX_DATA_RATE)
    unsigned char max_data_rate;    /*!< desired data rate                  */
#endif
    /*
     * Flags (bitfields)
     */
...
#if defined(MBEDTLS_SSL_MAX_FRAGMENT_LENGTH)
/*
 * ENHANCEMENT by FotaHub: Enable maximum fragment length to be negociated and
 * applied after TLS handshake only.
 */
    unsigned int mfl_code : 5;      /*!< desired fragment length            */
#endif
#if defined(MBEDTLS_SSL_ENCRYPT_THEN_MAC)
...
#if defined(MBEDTLS_SSL_MAX_DATA_RATE)
/**
 * \brief          Set the maximum data rate in KiB/s 
 *                 to emit and/or negotiate with peer
 *
 * \param conf     SSL configuration
 * \param max_data_rate value for maximum data rate
 * 
 * \return         0 if successful or MBEDTLS_ERR_SSL_BAD_INPUT_DATA
 */
int mbedtls_ssl_conf_max_data_rate( mbedtls_ssl_config *conf, unsigned char max_data_rate );
#endif /* MBEDTLS_SSL_MAX_DATA_RATE */
...
#if defined(MBEDTLS_SSL_MAX_DATA_RATE)
/**
 * \brief          Return the maximum data rate in KiB/s.
 *                 This is the value negotiated with peer if any,
 *                 or the locally configured value.
 *
 * \param ssl      SSL context
 *
 * \return         the current maximum data rate.
 */
unsigned char mbedtls_ssl_get_max_data_rate( const mbedtls_ssl_context *ssl );
#endif /* MBEDTLS_SSL_MAX_DATA_RATE */
