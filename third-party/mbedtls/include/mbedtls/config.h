 ...
 */
/**
 * \def MBEDTLS_SSL_MAX_DATA_RATE
 *
 * Enable support for FotaHub-defined max_data_rate extension in SSL.
 *
 * Comment this macro to disable support for the max_data_rate extension
 */
#define MBEDTLS_SSL_MAX_DATA_RATE
